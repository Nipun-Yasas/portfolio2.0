...
export const Button = ({ className, children, ...props }: ButtonProps) => {
  return (
    <button
      className={`group relative overflow-hidden rounded-full border-2 border-textPrimary px-6 py-3 sm:px-4 sm:py-2 text-sm font-medium transition-all duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] active:scale-95 active:brightness-90 cursor-pointer z-0 ${className}`}
      {...props}
    >
