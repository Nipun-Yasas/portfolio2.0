...
const DEFAULT_IMAGES: ImageItem[] = [
    ...
    {
        src: "/gallery/InnovateX2.jpg",
        alt: "InnovateX Event 2",
    },
    {
        src: "/gallery/InnovateX4.jpg",
        alt: "InnovateX Event 4",
    },
    {
        src: "/gallery/InnovateX5.jpg",
        alt: "InnovateX Event 5",
    },
    {
        src: "/gallery/InnovateX6.jpg",
        alt: "InnovateX Event 6",
    },
    {
        src: "/awards/Devthon.jpg",
        alt: "Devthon Event 3",
    },
    {
        src: "/gallery/Devthon2.jpg",
        alt: "Devthon Event 2",
    },
    {
        src: "/gallery/Devthon3.jpg",
        alt: "Devthon Event 3",
    },
    {
        src: "/gallery/Devthon4.jpg",
        alt: "Devthon Event 4",
    },
    {
        src: "/gallery/Devthon5.jpg",
        alt: "Devthon Event 5",
    },
    {
        src: "/awards/CodeRally.jpg",
        alt: "Devthon Event 3",
    },
    ...
    {
        src: "/gallery/RespairPro.jpg",
        alt: "RespairPro Project",
    },
];
                    ...
                    <div className="stage">
                        <div ref={sphereRef} className="sphere">
                            {items.map((it, i) => (
                                ...
                                >
                                    <div
                                        className="item__image absolute block overflow-hidden cursor-pointer bg-hoverPrimary transition-transform duration-300"
                                        role="button"
                                        tabIndex={0}
